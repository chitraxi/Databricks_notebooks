                ...
                count(DISTINCT CASE WHEN authorized_at IS NOT NULL THEN a.id END) total_success
                 ...
                 WHERE 
                  ...
                  merchant_id IN
                                  ...
                                  WHERE        team_owner = 'Mid Market'   
                                  --team_owner = 'Mid Market'
                                  )
                  --AND
                  ...
                  --and a.id  in (select id from realtime_hudi_api.payments where created_date >= cast(CURRENT_DATE + interval '-7' day AS varchar(10)) and cps_route = 100 )
...
filtered_alert_list = alert_list[(alert_list['Total Attempts'] >= 10) & (~alert_list['Terminal ID'].isin(['KbUS4CqEuh3NbE','MLAzCbVfmVuM4f','MLAzCbVfmVuM4f','L0mtODyDcEc9SO','OzOGPmB6bxyQ9R','OsdF4NzmhLeef2'])) 
